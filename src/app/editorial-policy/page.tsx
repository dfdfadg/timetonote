...
export default function EditorialPolicyPage() {
  return (
    ...
    >
      ...
      <ul>
        <li>We prioritise manufacturer documentation, official support pages, government and public-health guidance, and recognised standards bodies.</li>
      ...
      <h2>Safety</h2>
      <p>
        Some problems involve electricity, gas, water damage, mould, batteries or health. In those guides we
